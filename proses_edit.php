...
if ($_POST) {
    ...
    $sql = "UPDATE daftar_pesanan SET id_paket_wisata='$id_paket_wisata', nama_pemesan='$nama_pemesan', 
        no_tlp='$no_tlp', tanggal_pemesanan='$tanggal_pemesanan', jumlah_peserta='$jumlah_peserta',
        jumlah_hari='$jumlah_hari', akomodasi='$layanan_penginapan', transportasi='$layanan_transportasi', 
        makanan='$layanan_makan', harga_paket='$harga_paket', total_tagihan='$jumlah_tagihan'
        WHERE id_daftar_pesanan='$id_daftar_pesanan'";
