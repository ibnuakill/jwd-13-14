...
while ($row = mysqli_fetch_array($selected_pesanan)) {
    ...
    $service_makanan = $row['service_makanan'];
...
while ($item = mysqli_fetch_array($selected_paket)) {
    ...
    $harga_servis_makan = $item['harga_servis_makan'];
}
?>
...
<div class="main-container">
    <div class="form-container">
        ...
        <form action="proses_edit.php" method="post">
            ...
            <label for="tanggal_pemesanan">Tanggal Pesan</label>
            <input type="date" name="tanggal_pemesanan" id="tanggal_pemesanan" value="<?php echo $tanggal_pemesanan; ?>" required />
            ...
            <div class="layanan-container">
                <div class="item-layanan">
                    <label for="layanan_penginapan">
                        Penginapan <?php echo  " " . number_format($harga_penginapan, 0, ',', '.'); ?></label>
                ...
                </div><!--end item-layanan-->

                <div class="item-layanan">
                    <label for="layanan_transportasi">
                        Transportasi <?php echo  " " . number_format($harga_transportasi, 0, ',', '.'); ?></label>
                ...
                <div class="item-layanan">
                    <label for="layanan_makan">
                        Makanan <?php echo  " " . number_format($harga_servis_makan, 0, ',', '.'); ?></label>
                    <input type="checkbox" name="layanan_makan" id="layanan_makan" value="<?php echo $harga_servis_makan; ?>"
                        <?php echo renderLayanan($service_makanan); ?> />
                </div><!--end item-layanan-->
            </div><!--end layanan-container-->
    ...
    $(document).ready(function() {
        ...
        function perhitungan() {
            ...
            if ($('#layanan_makan').is(':checked')) {
                harga_servis_makan = $('#layanan_makan').val();
            }
            ...
            var harga_paket = parseInt(harga_penginapan) + parseInt(harga_transportasi) + parseInt(harga_servis_makan);
